...
<body bgcolor="#F99">
	...
	<form name="form1" method="post" action="">
		<table width="400" border="2" align="center" cellpadding="0"
			...
			<tr>
				<th height="30" align="right" bgcolor="#00FFFF">所存的存款时长：</th>
	...
	<p>
  	...
  	if(p==null){
		...
		out.println("<div align='center'>所存的存款时长："+I);
		out.println("<div align='center'>到最后期望的金额："+N);	
		out.println("<div align='center'><strong>通过复利的股票型存款本金翻倍的报酬率为："+f);
		}
