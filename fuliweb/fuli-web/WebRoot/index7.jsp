...
<body bgcolor="#990">
	<div align="center">
		<p>
		<a href="index7.jsp">月等额本息还款计算</a></p>
	</div>
	<form name="form1" method="post" action="">
		<table width="400" border="2" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<th width="235" height="30" align="right" bgcolor="#00FFFF">请输入你所贷款金额：</th>
				<th width="165" bgcolor="#00FFFF"><input name="benjin"
					type="text" id="benjin"></th>
			</tr>
			<tr>
				<th height="30" align="right" bgcolor="#00FFFF">你所贷款的年利率：</th>
				<th bgcolor="#00FFFF"><input name="lilv" type="text" id="lilv">
				</th>
			</tr>
			<tr>
				<th height="30" align="right" bgcolor="#00FFFF">你贷款的还款时长（月）：</th>
	...
	<p>
  	...
  	if(p==null){
		...
		double f=P*(I*Math.pow(1+I,N))/(Math.pow(1+I,N)-1);
		out.println("<div align='center'>你所贷款金额："+P);
		out.println("<div align='center'>你所贷款的年利率："+I);
		out.println("<div align='center'>你贷款的还款时长（月）："+N);	
		out.println("<div align='center'><strong>你每月等额本息还款是："+String.format("%.2f", f));
		}
