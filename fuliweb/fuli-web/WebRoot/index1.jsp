...
<body bgcolor="#CF0">
	...
	<form name="form1" method="post" action="">
		<table width="400" border="2" align="center" cellpadding="0"
			...
			<tr>
				<th height="30" align="right" bgcolor="#00FFFF">你所存的年利率比：</th>
				<th bgcolor="#00FFFF"><input name="lilv" type="text" id="lilv">
				</th>
			</tr>
			<tr>
				<th height="30" align="right" bgcolor="#00FFFF">你所存的年限：</th>
				<th bgcolor="#00FFFF"><input name="year" type="text" id="year">
				</th>
			</tr>
			<tr>
				<th height="30" align="right" bgcolor="#00FFFF">你所存的复利次数：</th>
